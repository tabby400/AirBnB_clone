#!/usr/bin/python3
""" Displays unittests for models/amenity.py.
Unittest classes:
...
class TestAmenity_instantiation(unittest.TestCase):
    ...
    def test_no_args_instantiates(self):
        # checks if the class Amenity is the same type as the instance of amenity
    ...
    def test_id_is_public_str(self):
        # checks that the id of the Amenity class is a string.
    ...
    def test_name_is_public_class_attribute(self):
        ...
        # 2. We’re creating a new instance of Amenity
        am = Amenity()
    ...
    def test_str_representation(self):
        ...
        # 2. We create a string representation of dt and store it in
        dt = datetime.today()
        dt_repr = repr(dt)
        am = Amenity()
         am.id = "123456"
    ...
    def test_args_unused(self):
        # 1. We create a new instance of Amenity.
        # 2. check that the instance’s __dict__ does not contain None as a value.
        am = Amenity(None)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        # 2. We create a datetime object using the datetime.today() 
        dt = datetime.today()
        dt_iso = dt.isoformat()
